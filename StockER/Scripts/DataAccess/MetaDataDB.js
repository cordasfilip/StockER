App.DataAccess.MetaDataDB =
    {
        GetMetaDataAsync: function ()
        {
            ...
            App.DataAccess.PortfolioDB.GetAllAsync().done(function (ports)
            {
                ...
                {
                    return {Id: item.Id, "Type": "ActionLinq", "Value": { "Text": item.Name, "Icon": item.Icon, "Href": "#/Dashboard/Portfolio/" + item.Id }, Order: index };
                }).ToArray();
        ...
        SetLeftNavigationItems: function (items)
        {
            App.Data.MetaData.LeftNavigationItems = items;

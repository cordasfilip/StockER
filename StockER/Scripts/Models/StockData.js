...
function StocHistoricalkData(startValues)
{
    this.Date=startValues.Date ;
    this.Open = startValues.Open;
    this.High = startValues.High;
    this.Low = startValues.Low;
    this.Close = startValues.Close;
    this.Volume = startValues.Volume;
    this.AdjClose = startValues.AdjClose;
}
